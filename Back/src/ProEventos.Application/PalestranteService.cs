    ...
    public class PalestranteService : IPalestranteService
    {
        ...
        public async Task<PalestranteDto> UpdatePalestrante(int userId, PalestranteUpdateDto model)
        {
            try
            {
                ...
                if (await _palestrantePersist.SaveChangesAsync())
                {
                    var resultadoUpdate = await _palestrantePersist.GetPalestranteByUserIdAsync(userId, false);
                    return _mapper.Map<PalestranteDto>(resultadoUpdate);
                }
                return null;
        ...
        //     try
        //     {
        //         var eventos = await _eventoPersist.GetAllEventosByTemaAsync(userId, tema, true);
